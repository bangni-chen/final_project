...
## The Data
This dataset includes Instagram post-level metrics for reach and engagement. Key numeric columns are Impressions, Likes, Comments, Saves, Shares, Profile Visits, Follows, and the breakdown of impressions by source (From Home, From Hashtags, From Explore, From Other). There are also two text columns: Caption and Hashtags. The goal of the analysis is clear and testable: to see which content and distribution features predict post reach and engagement, and whether the text in captions or hashtags is associated with higher engagement.
